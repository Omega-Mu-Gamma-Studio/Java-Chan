...
export const SHOP_ITEMS = [
  ...
  },
  {
    ...
    filter: 'none',
    spriteOverrides: {
      idle:         { src: '/sprites/uniforms/sports/teaching.png',   blend: false },
      'idle-sleep': { src: '/sprites/uniforms/sports/idle.png',       blend: false },
      happy:        { src: '/sprites/uniforms/sports/oops.png',       blend: false },
      thinking:     { src: '/sprites/uniforms/sports/thinking.png',   blend: false },
      sad:          { src: '/sprites/uniforms/sports/frustrated.png', blend: false },
      surprised:    { src: '/sprites/uniforms/sports/excited.png',    blend: false },
      domain:       { src: '/sprites/uniforms/sports/excited.png',    blend: false },
    },
    imageSrc: null,
  ...
  },
  {
    ...
    filter: 'none',
    spriteOverrides: {
      idle:         { src: '/sprites/uniforms/t-shirt/teaching.png',   blend: false },
      'idle-sleep': { src: '/sprites/uniforms/t-shirt/idle.png',       blend: false },
      happy:        { src: '/sprites/uniforms/t-shirt/oops.png',       blend: false },
      thinking:     { src: '/sprites/uniforms/t-shirt/thinking.png',   blend: false },
      sad:          { src: '/sprites/uniforms/t-shirt/frustrated.png', blend: false },
      surprised:    { src: '/sprites/uniforms/t-shirt/excited.png',    blend: false },
      domain:       { src: '/sprites/uniforms/t-shirt/excited.png',    blend: false },
    },
    imageSrc: null,
...
export const DOWNLOADABLE_WALLPAPERS = [
  ...
  },
  {
    ...
    gradient: 'linear-gradient(160deg, #1a0e0a 0%, #3d2210 55%, #2a1508 100%)',
    accent: '#ffaa44',
    imageSrc: '/wallpapers/train-platform.png',
  ...
  },
  {
    ...
    gradient: 'linear-gradient(160deg, #2e1a0a 0%, #4a2e1a 55%, #1a0f0a 100%)',
    accent: '#ffcc6e',
    imageSrc: '/wallpapers/golden-hour.png',
  ...
  },
  {
    ...
    accent: '#ffe066',
    imageSrc: '/wallpapers/convenience-store.png',
  ...
  },
  {
    ...
    accent: '#a0c8ff',
    imageSrc: '/wallpapers/hot-chocolate.png',
